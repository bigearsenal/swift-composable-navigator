...
public struct Navigator {
    ...
    public init(
        ...
        _path = path
        _go = go
        _goToOnScreen = goToOnScreen
        _goToPath = goToPath
        _goToPathOnScreen = goToPathOnScreen
        _goBack = goBack
        _goBackToID = goBackToID
        _replace = replace
        _dismiss = dismiss
        _dismissScreen = dismissScreen
        _dismissSuccessor = dismissSuccessor
        _dismissSuccessorOfScreen = dismissSuccessorOfScreen
